...
![Task 2 - Log Metric Filter](./images/MN-01-log-metric-filter.png)
...
![Task 2 - CloudWatch Email Notification Alarm](./images/MN-01-email-notification-alarm.png)
...
![Task 3 - EC2 Monitoring](./images/MN-01-ec2-monitoring.png)
...
![Task 3 - CloudWatch CWAgent Metrics](./images/MN-01-CWAgent-metrics.png)

CloudWatch also captures additional metrics that are automatically generated by AWS services used within the account.
These metrics provide insights into resource utilization and service performance without requiring manual configuration.

![Task 3 - All CloudWatch Metrics](./images/MN-01-cloudwatch-metrics.png)
