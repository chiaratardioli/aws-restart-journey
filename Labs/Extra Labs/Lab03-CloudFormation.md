...
![CloudFormation template structure](./images/MN-01-template-structure.png)
...
![Create stack upload template](./images/MN-01-create-stack-upload.png)
...
![S3 bucket template edit](./images/MN-01-s3-template-edit.png)
...
![Stack update preview changes](./images/MN-01-update-preview.png)
...
![S3 bucket created](./images/MN-01-s3-created.png)
...
![AMI parameter added](./images/MN-01-ami-parameter.png)
...
![EC2 template configuration](./images/MN-01-ec2-template.png)
...
![Delete stack confirmation](./images/MN-01-delete-stack.png)
...
![Stack deletion complete](./images/MN-01-delete-complete.png)
